...
def main() -> int:
    ...
    parser.add_argument("--profile", choices=("production", "fixture"), default="production")
    ...
    policy = ValidationPolicy.fixture() if args.profile == "fixture" else ValidationPolicy()
    try:
        if args.freeze_test:
